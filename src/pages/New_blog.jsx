...
export default function New_blog() {
    return (
        <>
            <section className="py-24 bg-[#0a0a0a] relative overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-4">
                        <div>
                            <span className="section-label mb-4  flex items-center w-fit text-orange-400 rounded-full bg-orange-400/20 border border-orange-500/30 px-4 py-2">
                                <span className="relative flex h-2 w-2 ml-2">
                                    <span className="animate-ping absolute inline-flex rounded-full bg-orange-500 opacity-75">
                                    </span>

                                    <span className="relative animate-ping  inline-flex rounded-full h-2 w-2 bg-orange-500">
                            ...
                            <h2 className="section-title text-white text-3xl md:text-3xl lg:text-6xl font-bold mb-4">أحدث المقالات</h2>
                            <p className="section-subtitle  max-w-lg text-lg text-neutral-400 ">محتوى جديد طازج من المطبعة</p>
                        </div>
                        <a className="group inline-flex items-center gap-2 text-orange-500 font-semibold hover:text-orange-400 transition-colors" href="/blog" data-discover="true">عرض جميع المقالات
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <article className="rounded-3xl bg-[#262626]/50  shadow card group overflow-hidden" style={{ animationDelay: "100ms" }}>
                            <a className="block" href="/blog/camera-settings-basics" data-discover="true">
                                <div className="relative h-52 overflow-hidden">
                                    <img alt="أساسيات إعدادات الكاميرا: مثلث التعريض الضوئي" className="rounded-r-3xl3xl w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 ease-out" src="https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=800&amp;h=400&amp;fit=crop" />
                        ...
                        <article className="rounded-3xl bg-[#262626]/50  shadow group card overflow-hidden" style={{ animationDelay: "200ms" }}>
                            <a className="block" href="/blog/photo-composition-rules" data-discover="true">
                                <div className="relative h-52 overflow-hidden">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex items-center justify-between pt-4 border-t border-[#262626]">
                                        <div className="flex items-center gap-3">
                                            <img alt="ليث محمود" className="w-9 h-9 rounded-full object-cover ring-2 ring-[#262626]" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100&amp;h=100&amp;fit=crop&amp;crop=face" /><div>
                        ...
                        <article className="rounded-3xl bg-[#262626]/50  shadow group card overflow-hidden" style={{ animationDelay: "200ms" }}>
                            <a className="block" href="/blog/mobile-photography-tips" data-discover="true">
                                <div className="relative h-52 overflow-hidden">
