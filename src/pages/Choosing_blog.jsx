...
export default function Choosing_blog() {
  return (
    <>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-4">
          ...
          <div>
            ...
            <h2 className="section-title text-white text-3xl md:text-3xl lg:text-6xl font-bold mb-4">
              مقالات مختارة
            </h2>

            <p className="section-subtitle max-w-lg text-lg text-neutral-400 ">
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <a className="block" href="/blog/mastering-golden-hour-photography">
          ...
          >
            ...
            <a className="block" href="/blog/portrait-photography-secrets">
          ...
          >
            ...
            <a className="block" href="/blog/landscape-photography-guide">
